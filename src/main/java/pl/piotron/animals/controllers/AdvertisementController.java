...
public class AdvertisementController {
    ...
    @PostMapping("")
    public ResponseEntity<AdvertisementDto> createAdvertisement(@Valid @RequestBody AdvertisementDto advertisement, @PathVariable(required = false) Long userId, BindingResult result)
    {
